    ...
    return (
      <a href={href}>
        <motion.div
          ...
          className="aspect-square rounded-full hover:border-black hover:border-2 flex items-center justify-center relative"
        >
          {/* <AnimatePresence>
            {hovered && (
              <motion.div
                ...
                exit={{
                  opacity: 0,
                  y: 1, // Decreased the height for smoother exit
                }}
                ...
                transition={{
                  duration: 0.2, // Adjust timing for smoother Y transition
                }}
              >
                {title}
              </motion.div>
